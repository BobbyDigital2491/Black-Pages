    ...
    <section>
        ...
        <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div className="max-w-lg mx-auto text-center xl:max-w-2xl">
                <h1 className="text-3xl font-bold text-white sm:text-4xl xl:text-5xl">The <span className='text-green-600'>Black</span> <span className='text-yellow-400'>Pages</span>: Black Owned Business Directory</h1>
                <p className="max-w-lg mx-auto mt-6 text-base font-normal leading-7 text-gray-300">Find the best black owned businesses in your area</p>
                ...
                <div className="grid max-w-md grid-cols-3 mx-auto mt-8 md:mt-16 lg:mt-24 xl:mt-32 gap-x-10 grid-col-2">
                    <div>
                    ...
                    <div>
                     ...
                     <div>
                        <p className="text-4xl font-bold text-white">7,600</p>
